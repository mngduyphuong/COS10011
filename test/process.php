...
<section class="content">
	...
	$text = sanitise_input($_POST["text"]);
	...
	if ($err_msg==""){				//if there is no error, input all the data to database
		...
		// 	$query = "INSERT into $sql_table (reference, username, qualification, email, phone) 
		// values ('$ref', '$username', '$quali', '$email', '$phone');";


			//aditional requirements
			$sql_table = 'test';
			$query = "INSERT into $sql_table (reference, username, qualification, email, phone, textarea) 
		values ('$ref', '$username', '$quali', '$email', '$phone', '$text');";
